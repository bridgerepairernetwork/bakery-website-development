      ...
      <div className="max-w-6xl mx-auto bg-primary rounded-[3rem] p-8 md:p-16 flex flex-col md:flex-row items-center gap-12 overflow-hidden relative shadow-2xl">
        ...
        <div className="relative z-10 flex-1 text-center md:text-left">
          ...
          <p className="text-white/80 text-lg mb-10 max-w-md">
            Our bespoke services book up fast. Secure your date and let us handle the details of your next celebration.
          </p>
          <div className="flex flex-wrap gap-4 justify-center md:justify-start">
            <button className="bg-accent text-white font-black px-12 py-5 rounded-full hover:scale-105 transition-transform uppercase tracking-widest shadow-xl shadow-accent/20">
              Inquire Now
            </button>
            <button className="bg-transparent border-2 border-white/30 text-white font-black px-10 py-5 rounded-full hover:bg-white/10 transition-all uppercase tracking-widest">
              View Portfolio
            </button>
          </div>
        </div>
        ...
        <div className="relative z-10 flex-1 w-full max-w-md">
          <div className="bg-white/10 p-10 rounded-2xl border border-white/20 backdrop-blur-xl">
            ...
            <p className="text-white/70 text-sm mb-8">Be the first to hear about seasonal cake drops and event design trends.</p>
