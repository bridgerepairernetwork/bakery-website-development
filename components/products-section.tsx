      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div className="max-w-xl">
            <h2 className="text-accent font-bold tracking-widest uppercase text-sm mb-2">Signature Series</h2>
            <h3 className="text-4xl md:text-5xl font-black text-primary">Perfectly White Classics</h3>
          </div>
          <button className="text-primary font-black flex items-center gap-2 hover:text-accent transition-colors uppercase text-sm tracking-widest w-fit">
          ...
          {PRODUCTS.map((product) => (
            ...
            >
              ...
              <div className="flex justify-between items-start px-1">
                <div>
                  <h4 className="font-bold text-lg text-primary">{product.name}</h4>
                  <p className="text-sm text-primary/50">{product.description}</p>
                </div>
